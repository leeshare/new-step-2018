...
import { seachBaseLibrary, saveSentenceInfo, deleteSentenceInfo } from '@/actions/tm';
import { getDictionaryTitle } from '@/utils';
import SentenceView from '../View';
const FormItem = Form.Item;
class SentenceManage extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            expand:false,
        ...
        },
        {
            ...
            render: (text, record) => (
                <span>
                    ...
                    <a onClick={() => { this.onLookView('Edit', {...record,SentenceID:''}) }}>复制</a>
                    <span className="ant-divider" />
                        ...
                        >
                            ...
                            <Row>
                                <Col span={24} style={{ textAlign: 'right' }}>
                                    ...
                                    <Button style={{ marginLeft: 8}} onClick={() => { this.onLookView('Create', {}) }} icon="plus">词句</Button>
...
//表单组件 封装
const WrappedSentenceManage = Form.create()(SentenceManage);
...
function mapDispatchToProps(dispatch) {
    return {
        ...
        saveSentenceInfo: bindActionCreators(saveSentenceInfo, dispatch),
        deleteSentenceInfo: bindActionCreators(deleteSentenceInfo, dispatch)
    };
}
//redux 组件 封装
export default connect(mapStateToProps, mapDispatchToProps)(WrappedSentenceManage);
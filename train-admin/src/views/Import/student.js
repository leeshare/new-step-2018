...
class ImportStudent extends React.Component {
    constructor(props) {
        super(props)
    ...
    render() {
        ...
        switch (this.state.editMode) {
            case "Import":
                block_content = <Templet viewCallback={this.onViewCallback} {...this.state} />
                break;
            case "Manage":
            default:
                block_content = (
                        ...
                        >
                            ...
                            <Row>
                                <Col span={24} style={{ textAlign: 'left' }}>
                                    <ButtonGroup>
                                        <Button type='primary' onClick={() => { this.onLookView('Import', {Folder: {IsToOrgRead: 0}, AuthUserList: []}) }} ghost>{YSI18n.get('导入')}</Button>
                                    </ButtonGroup>
...
//表单组件 封装
const WrappedAuthManage = Form.create()(ImportStudent);

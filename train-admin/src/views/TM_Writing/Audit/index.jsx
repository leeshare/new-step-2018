...
class ReaderAudit extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            expand: false,
            ...
            pagingSearch: { PageIndex: 1, PageSize: 30, Keyword: '', Knowledges: '', AuditStatus: "1", Status: "-1", CourseWareType: 5, ApplicableScopes: "-1" },
...
//表单组件 封装
const WrappedReaderAudit = Form.create()(ReaderAudit);
...
//redux 组件 封装
export default connect(mapStateToProps, mapDispatchToProps)(WrappedReaderAudit);
...
class CollectManage extends React.Component {
  constructor(props) {
    super(props);
...
//表单组件 封装
const WrappedCollectManage = Form.create()(CollectManage);
...
//redux 组件 封装
export default connect(mapStateToProps, mapDispatchToProps)(WrappedCollectManage);

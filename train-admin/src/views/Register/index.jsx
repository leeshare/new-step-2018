  ...
  render () {
    ...
    return (
      <Row className="register-row" type="flex" justify="space-around" align="middle">
        <Col span="8">
          <Form layout="horizontal" className="register-form">
            ...
            <p>
              <Button className="btn-register" type='primary' size="large" icon="right-square-o" loading={this.state.loading}  onClick={this.handleSubmit.bind(this)} >注册</Button>
            </p>
            <p>

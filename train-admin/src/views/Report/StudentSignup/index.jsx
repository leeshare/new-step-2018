...
import { getReportOfStudentSignup } from '@/actions/report';
...
class StudentSignup extends React.Component {
    ...
    onSearch = (e) => {
        ...
        this.props.form.validateFields((err, values) => {
            ...
            this.props.getReportOfStudentSignup(pagingSearch).payload.promise.then((response) => {
    ...
    render() {
        ...
        let xData = this.state.dic_CourseSpecialtys.map(item => item.title);
...
//表单组件 封装
const WrappedFeeOfMonth = Form.create()(StudentSignup);
...
function mapDispatchToProps(dispatch) {
    return {
        getReportOfStudentSignup: bindActionCreators(getReportOfStudentSignup, dispatch),
    };
}
//redux 组件 封装

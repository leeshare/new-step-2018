...
class TeachClassManage extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            expand: false,
            ...
            pagingSearch: { PageIndex: 1, PageSize: 30, Keyword: '', Status: "-1", Teacher: '', CourseSpecialty: '', CourseLevel: '', PeriodType: '', BeginDate: '', EndDate: '', TeachWay: '-1', Timezone: '' },
            dic_Status: [],
                        ...
                        >
                            ...
                            <Row>
                                <Col span={24} style={{ textAlign: 'right' }}>
                                    ...
                                    <Button style={{ marginLeft: 8 }} onClick={() => { this.onLookView('Create', { TeachWay: 1 }) }} icon="plus">新增班级</Button>
...
//表单组件 封装
const WrappedTeachClassManage = Form.create()(TeachClassManage);
...
//redux 组件 封装
export default connect(mapStateToProps, mapDispatchToProps)(WrappedTeachClassManage);
...
class RotationManage extends React.Component {
    constructor(props) {
        super(props)
    ...
    fetch = (pagingSearch) => {
        ...
        this.props.getRotationList({type:2, appType: 1}).payload.promise.then((response) => {
...
//表单组件 封装
const WrappedDictionaryManage = Form.create()(RotationManage);

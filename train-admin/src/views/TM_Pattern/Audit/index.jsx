...
class PatternAudit extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            expand:false,
            ...
            pagingSearch: { PageIndex: 1, PageSize: 30, Keyword: '', Knowledges: '', AuditStatus:"1", Status: "-1", CourseWareType: 4, ApplicableScopes: "-1"},
...
//表单组件 封装
const WrappedPatternAudit = Form.create()(PatternAudit);
...
//redux 组件 封装
export default connect(mapStateToProps, mapDispatchToProps)(WrappedPatternAudit);
                    ...
                    <Form>
                        ...
                        >
                            {getFieldDecorator('Content_En', {
                                ...
                                rules: [{
                                    required: false, message: '请输入句型英文内容!',
                                }],
                            })(
                                <TextArea rows={3} />
                                )}
...
const WrappedPatternView = Form.create()(PatternView);
...
export default connect(mapStateToProps, mapDispatchToProps)(WrappedPatternView);
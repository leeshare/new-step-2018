...
viewCallback [回调]
*/
class SSO_BranchOrganizationView extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
...
const WrappedSSO_BranchOrganizationView = Form.create()(SSO_BranchOrganizationView);
...
export default connect(mapStateToProps, mapDispatchToProps)(WrappedSSO_BranchOrganizationView);
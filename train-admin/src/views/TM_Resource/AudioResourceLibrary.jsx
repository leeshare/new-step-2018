...
class AudioResourceLibrary extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            expand: false,
            ...
            pagingSearch: { PageIndex: 1, PageSize: 40, Keyword: '', FileName: '', Systemkeyword: '', Description: '', Status: "1", ResourceType: "2", IncludeResourceVersionTypes: [] },
            dic_resourceTypes: [],
            dic_Status: [],
    ...
    columns = [
        {
            ...
            render: (text, record, index) => {
                return <a onClick={() => { this.onPlayAudio(record.FileUrl) }}><Icon type="sound" />{record.ResourceName}</a>
            }
        },
        {
            title: `关键词`,
...
//表单组件 封装
const WrappedAudioResourceLibrary = Form.create()(AudioResourceLibrary);
...
//redux 组件 封装
export default connect(mapStateToProps, mapDispatchToProps)(WrappedAudioResourceLibrary);
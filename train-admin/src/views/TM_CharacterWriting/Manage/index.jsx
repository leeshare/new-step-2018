...
import { searchCharaterWritingLibrary, saveCharacterWritingInfo, deleteCharacterWritingInfo } from '@/actions/tm';
import { getDictionaryTitle } from '@/utils';
import CharacterWritingView from '../View';
const FormItem = Form.Item;
class CharacterWritingManage extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            expand:false,
            ...
            pagingSearch: { PageIndex: 1, PageSize: 30, Keyword: '', Status: "-1", AuditStatus: "-1",ApplicableScopes: '-1' },
...
//表单组件 封装
const WrappedCharacterWritingManage = Form.create()(CharacterWritingManage);
...
function mapDispatchToProps(dispatch) {
    return {
        ...
        saveCharacterWritingInfo: bindActionCreators(saveCharacterWritingInfo, dispatch),
        deleteCharacterWritingInfo: bindActionCreators(deleteCharacterWritingInfo, dispatch)
    };
}
//redux 组件 封装
export default connect(mapStateToProps, mapDispatchToProps)(WrappedCharacterWritingManage);
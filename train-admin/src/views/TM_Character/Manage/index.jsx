...
import { seachBaseLibrary, saveCharacterInfo, deleteCharacterInfo } from '@/actions/tm';
                        ...
                        >
                            ...
                            <Row>
                                <Col span={24} style={{ textAlign: 'right' }}>
                                    ...
                                    <Button style={{ marginLeft: 8}} onClick={() => { this.onLookView('Create', {}) }} icon="plus">字</Button>
...
//表单组件 封装
const WrappedCharacterManage = Form.create()(CharacterManage);
...
function mapDispatchToProps(dispatch) {
    return {
        ...
        saveCharacterInfo: bindActionCreators(saveCharacterInfo, dispatch),
        deleteCharacterInfo: bindActionCreators(deleteCharacterInfo, dispatch)
    };
}
//redux 组件 封装
export default connect(mapStateToProps, mapDispatchToProps)(WrappedCharacterManage);
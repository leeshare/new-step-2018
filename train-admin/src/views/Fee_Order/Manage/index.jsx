...
class FeeOrderManage extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            expand: false,
            ...
            <Col span={8}>
                ...
                >
                    {getFieldDecorator('Status', { initialValue: this.state.pagingSearch.Status })(
                        <Select>
                            <Option value="-1">全部</Option>
                            {this.state.dic_OrderStatus.map((item) => {
                                return <Option value={item.value}>{item.title}</Option>
                            })}
                        </Select>
                    )}
                        ...
                        >
                            ...
                            <Row>
                                <Col span={24} style={{ textAlign: 'right' }}>
                                    ...
                                    <Button style={{ marginLeft: 8 }} onClick={() => { this.onLookView('Create', { FormOrderDetails: [{}, {}, {}], CourseSpecialty: this.state.pagingSearch.CourseSpecialty }) }} icon="plus">新增订单</Button>
...
//表单组件 封装
const WrappedFeeOrderManage = Form.create()(FeeOrderManage);

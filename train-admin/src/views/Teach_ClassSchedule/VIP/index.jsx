...
class TeachClassScheduleVIP extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            expand: false,
            ...
            pagingSearch: { PageIndex: 1, PageSize: 30, Keyword: '', Status: "-1", PeriodType: '02', TeachClassID: '', TeachClassRoomID: '', Teacher: '', BeginDate: '', EndDate: '' },
            dic_TeachWays: [],
            dic_TeachClass: [],
            dic_Timezones: [],
                        ...
                        >
                            ...
                            <Row>
                                <Col span={24} style={{ textAlign: 'right' }}>
                                    ...
                                    <Button style={{ marginLeft: 8 }} onClick={() => { this.onLookView('BatchCreate', { PeriodType: this.state.pagingSearch.PeriodType }) }} icon="plus-square-o">批量1对1授课安排</Button>
                                    <Button style={{ marginLeft: 8 }} onClick={() => { this.onLookView('Create', { PeriodType: this.state.pagingSearch.PeriodType }) }} icon="plus">1对1授课安排</Button>
...
//表单组件 封装
const WrappedTeachClassScheduleVIP = Form.create()(TeachClassScheduleVIP);
...
//redux 组件 封装
export default connect(mapStateToProps, mapDispatchToProps)(WrappedTeachClassScheduleVIP);
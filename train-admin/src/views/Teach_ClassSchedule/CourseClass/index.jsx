...
class TeachClassScheduleCourseClass extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            expand: false,
            ...
            pagingSearch: { PageIndex: 1, PageSize: 30, Keyword: '', Status: "-1", PeriodType: '01', TeachClassID: '', TeachClassRoomID: '', Teacher: '', BeginDate: '', EndDate: '' },
            dic_TeachWays: [],
            dic_TeachClass: [],
            dic_Timezones: [],
...
//表单组件 封装
const WrappedTeachClassScheduleCourseClass = Form.create()(TeachClassScheduleCourseClass);

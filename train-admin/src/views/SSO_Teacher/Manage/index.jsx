...
import { getOrganizationTeacherList, getUserInfoByUserName, saveOrganizationTeacherInfo, switchOrganizationUserInfoStatus, deleteOrganizationUserInfo, resetUserPassword } from '@/actions/admin';
...
class TeacherManage extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            pagingSearch: { PageIndex: 1, PageSize: 30, Keyword: '', Status: '-1', UserType: 2, UserImageStatus: '-1', CourseSpecialty: '', CourseLevel: '' },
            dic_UserTypes: [],
            dic_Status: [],
            dic_SexTypes: [],
    ...
    render() {
        ...
        switch (this.state.editMode) {
            ...
            default:
                block_content = (
                    <div >
                        {this.state.showAlertTip ? <div style={{ marginBottom: 20 }}>
                            <Alert
                                message="温馨提示"
                                description="不能直接添加教师，如需添加请联系总部人员！"
                                type="warning"
                                showIcon
                                closable={true}
                                onClose={() => { this.setState({ showAlertTip: false }) }}
                            />
                        </div> : ''}
                        <Form
                        ...
                        >
                            ...
                            <Row>
                                <Col span={24} style={{ textAlign: 'right' }}>
                                    ...
                                    <Button style={{ marginLeft: 8 }} onClick={() => { this.setState({ showAlertTip: true }) }} icon="plus">新增教师</Button>
...
//表单组件 封装
const WrappedStudentManage = Form.create()(TeacherManage);

...
class TeacherQuery extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            expand: false,
            ...
            pagingSearch: { PageIndex: 1, PageSize: 30, Keyword: '', Status: '-1', UserType: 1, UserImageStatus: '-1', CourseSpecialty: '', CourseLevel: '' },
            dic_UserTypes: [],
            dic_Status: [],
            dic_SexTypes: [],
    ...
    render() {
        ...
        switch (this.state.editMode) {
            ...
            case "View":
            case "Delete":
                block_content = <TeacherView viewCallback={this.onViewCallback} {...this.state}/>
                break;
            case "Manage":
            default:
                block_content = (
                        ...
                        >
                            ...
                            <Row>
                                <Col span={24} style={{ textAlign: 'right' }}>
                                    ...
                                    {/* <Button style={{ marginLeft: 8 }} onClick={() => { this.onLookView('Create', {}) }} icon="plus">新增学员</Button> */}
...
//表单组件 封装
const WrappedStudentManage = Form.create()(TeacherQuery);

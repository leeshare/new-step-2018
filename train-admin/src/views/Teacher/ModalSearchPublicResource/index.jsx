...
import { getPublicCategoryResList } from '@/actions/teach';
import { getDictionaryTitle } from '@/utils';

import ModalPlayer from '@/components/ModalPlayer';
import ResourceCard from '@/components/ResourceCard';
const FormItem = Form.Item;
class ModalSearchPublicResource extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            pagingSearch: { PageIndex: 1, PageSize: 20, Keyword: '',CategoryName:'', ResourceType: "-1", ExcludeTeachScheduleID: props.TeachScheduleID, BeginDate: '', EndDate: ''},
            dic_ResourceTypes: [],
            data_list: [],
            data_list_total: 0,
            loading: false
...
//表单组件 封装
const WrappedModalSearchPublicResource = Form.create()(ModalSearchPublicResource);
...
//redux 组件 封装
export default connect(mapStateToProps, mapDispatchToProps)(WrappedModalSearchPublicResource);
...
viewCallback [回调]
*/
class JiaocaiView extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
                    ...
                    <Form>
                        ...
                        >
                            {getFieldDecorator('FormImagePath', {
                                ...
                                rules: [{
                                    required: true, message: '请上传教材封面图片!',
                                }]
                            }
                            )(
                                <ImageUpload />
                        ...
                        <FormItem
                            ...
                            label="适用对象"
                        >
                            {getFieldDecorator('TopicType', { initialValue: this.state.dataModel.ApplicableScopes })(
                                <Select>
                        ...
                        }
                        {
                            ...
                            >
                                {getFieldDecorator('AuditRemark', {
                                    rules: [{
                                        required: true, message: '请对本次教材修改进行说明!',
                                    }]
                                })(
                                    <TextArea rows={4} />
                                    )}
...
const WrappedJiaocaiView = Form.create()(JiaocaiView);
...
export default connect(mapStateToProps, mapDispatchToProps)(WrappedJiaocaiView);
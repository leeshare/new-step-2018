...
viewCallback [回调]
*/
class CourseGroupView extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
                    ...
                    <Form>
                        ...
                        >
                            {getFieldDecorator('FormImagePath', {
                                ...
                                rules: [{
                                    required: true, message: '请上传课程封面图片!',
                                }]
                            }
                            )(
                                <ImageUpload />
                        ...
                        }
                        {
                            ...
                            >
                                {getFieldDecorator('AuditRemark', {
                                    rules: [{
                                        required: true, message: '请对本次课程修改进行说明!',
                                    }]
                                })(
                                    <TextArea rows={4} />
                                    )}
...
const WrappedCourseGroupView = Form.create()(CourseGroupView);
...
export default connect(mapStateToProps, mapDispatchToProps)(WrappedCourseGroupView);
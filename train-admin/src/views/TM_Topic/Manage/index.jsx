...
class TopicManage extends React.Component {
    ...
    render() {
        ...
        switch (this.state.editMode) {
            case "ManageCourse":
                block_content = <Card title={'主题学习任务列表'} extra={<a onClick={() => { this.onViewCallback() }}><Icon type="rollback" />返回</a>}>
                        ...
                        >
                            ...
                            <Row>
                                <Col span={24} style={{ textAlign: 'right' }}>
                                    ...
                                    <Button style={{ marginLeft: 8 }} onClick={() => { this.onLookView('Create', {}) }} icon="plus">主题</Button>

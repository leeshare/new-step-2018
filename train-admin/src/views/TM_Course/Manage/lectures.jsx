...
class LectureCourseManage extends React.Component {
    state = {
        expand: false,
        viewMode: 'Manage',//Manage,View,Edit,Create,Design
        pagingSearch: { PageIndex: 1, PageSize: 30, Keyword: '', ApplicableScopes: '-1', Status: "-1", AuditStatus: "-1", SupportUnitType: '-1', IsLecture: true },
                        ...
                        >
                            ...
                            <Row>
                                <Col span={24} style={{ textAlign: 'right' }}>
                                    ...
                                    <Button style={{ marginLeft: 8 }} onClick={() => { this.onLookView('Create', {}) }} icon="plus">教学任务</Button>
...
const WrappedLectureCourseManage = Form.create()(LectureCourseManage);
...
export default connect(mapStateToProps, mapDispatchToProps)(WrappedLectureCourseManage);

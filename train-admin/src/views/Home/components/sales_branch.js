    ...
    <div className={'sales'}>
      ...
      <ResponsiveContainer minHeight={360}>
        <LineChart data={data}>
          ...
          <Line type="monotone" dataKey="报名订单" stroke={color.red} strokeWidth={3} dot={{ fill: color.red }} activeDot={{ r: 5, strokeWidth: 0 }} />
          <Line type="monotone" dataKey="授课安排" stroke={color.green} strokeWidth={3} dot={{ fill: color.green }} activeDot={{ r: 5, strokeWidth: 0 }} />
          <Line type="monotone" dataKey="学生上课" stroke={color.sky} strokeWidth={3} dot={{ fill: color.sky }} activeDot={{ r: 5, strokeWidth: 0 }} />
        </LineChart>
      </ResponsiveContainer>
    </div>
  )

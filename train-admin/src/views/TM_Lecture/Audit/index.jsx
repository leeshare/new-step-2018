...
class LectureAudit extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            expand:false,
            ...
            pagingSearch: { PageIndex: 1, PageSize: 30, Keyword: '', AuditStatus:"1", Status: "-1", CourseWareType: 8, ApplicableScopes: "-1"},
...
//表单组件 封装
const WrappedLectureAudit = Form.create()(LectureAudit);
...
//redux 组件 封装
export default connect(mapStateToProps, mapDispatchToProps)(WrappedLectureAudit);
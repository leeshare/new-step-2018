...
//业务数据视图（增、删、改、查)
import InfoView from '../VideoInfoView';
import './index.less';
...
class ZixunVideoManage extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            pagingSearch: { pageIndex: 1, pageSize: 20, Keyword: '', Status: -1, InfoType: 2, channelIds: [-2], PublishBeginDate: null, PublishEndDate: null },
            data_list: [],
            data_list_total: 0,
            loading: false,
            channel_data_List: [],
                            ...
                            <Row>
                                <Col span={24} style={{ textAlign: 'center' }}>
                                    <ButtonGroup>
                                        ...
                                        <Button onClick={() => { this.onLookView('Create', { title: '', content: '', coverType: 1, covers: [], isRecommend: 0, isTop: 0, topNum: 0, channel_data_List: this.state.channel_data_List, channelList: [] }) }} icon="plus">{YSI18n.get('资讯')}</Button>
                                    </ButtonGroup>
                                </Col>
                            </Row>
                        </Form>
...
//表单组件 封装
const WrappedRoleManage = Form.create()(ZixunVideoManage);

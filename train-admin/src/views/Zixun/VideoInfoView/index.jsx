...
viewCallback [回调]
*/
class VideoInfoView extends React.Component {
    constructor(props) {
        super(props)
                    ...
                    <Form>
                        ...
                        >
                            {getFieldDecorator('content', {
                                ...
                                <VideoUpload functionType={'ZixunFiles'} />
                            )}
                        </FormItem>
                        <FormItem
                            {...formItemLayout}
                    ...
                    <Form>
                        ...
                        {this.state.dataModel.content != '' ?
                            <FormItem
                                ...
                                label="视频"
                            >
                                <a onClick={() => { this.onShowMediaPlayer(3, this.state.dataModel.content) }}> <Icon type="play-circle-o" />播放</a>
                            </FormItem> : ''}
                            <FormItem
                            {...formItemLayout}
                            label="视频介绍"
...
const WrappedStudentView = Form.create()(VideoInfoView);
